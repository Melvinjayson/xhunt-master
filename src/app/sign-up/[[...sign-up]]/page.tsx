      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 2, marginTop: 'auto', paddingTop: 60 }}>
          ...
          <p style={{ fontSize: 15, color: '#8B9CC0', lineHeight: 1.65, maxWidth: 340 }}>
            Create your free account and let AI match you with missions that align with your skills, passions, and values.
          </p>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginTop: 32 }}>
            <div style={{ display: 'flex' }}>
              {['#22FFAA', '#6D5DFD', '#FFB84D', '#FF5C7A'].map((c, i) => (
                <div key={i} style={{ width: 28, height: 28, borderRadius: '50%', background: c, border: '2px solid #050816', marginLeft: i ? -8 : 0, opacity: 0.85 }} />
              ))}
            </div>
